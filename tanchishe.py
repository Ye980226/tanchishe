...
class Snake:
    ...
    colors = [randint(0, 255) for i in range(120)]
    colors = list(product(colors, repeat=3))[1:-1]
    ...
    def generate_food(self):
        ...
        self.food_color = list(choice(self.colors))  # 随机生成
...
def main():
    ...
    welcome_words = title_font.render(
        'Welcome to My Snake', True, (0, 0, 0), (255, 255, 255))
    tips_font = pygame.font.SysFont('arial', 24)
    start_game_words = tips_font.render(
        'Click to Start Game', True, (0, 0, 0), (255, 255, 255))
    close_game_words = tips_font.render(
        'Press ESC to Close', True, (0, 0, 0), (255, 255, 255))
    gameover_words = title_font.render(
        'GAME OVER', True, (205, 92, 92), (255, 255, 255))
    win_words = title_font.render(
        'THE SNAKE IS LONG ENOUGH AND YOU WIN!', True, (0, 0, 205), (255, 255, 255))
    screen = pygame.display.set_mode((640, 480), 0, 32)
    pygame.display.set_caption('Leon')
    image = pygame.image.load("datawhale.jpg")
    ...
    while 1:
        ...
        if snake.game_started:
            ...
            if snake.head == snake.food:
                ...
                snake.body.pop(0)  # 没吃到食物就把多生出来的身体给丢掉
